...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="">
                <a href="{{ route('satuan.create') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah
                    Data</a>
            </div>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            @foreach ($satuans as $row)
                                <tr>
                                    <td>
                                        <a href="{{ route('satuan.edit', $row->id) }}" class="btn btn-sm btn-success"><i
